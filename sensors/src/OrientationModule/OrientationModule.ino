...
void loop() {
    ...
    Serial.print ('o');   // header character
    Serial.print (",");   // delimiter
    Serial.print(quat.x(), DEC); // data
    Serial.print (",");   // delimiter
    Serial.print(quat.y(), DEC); // data
    Serial.print (",");   // delimiter
    Serial.print(quat.z(), DEC); // data
    Serial.print (",");   // delimiter
    Serial.print(quat.w(), DEC); // data
    Serial.print (",");   // delimiter
    Serial.print(acc.x(), DEC); // data
    Serial.print (",");   // delimiter
    Serial.print(acc.y(), DEC); // data
    Serial.print (",");   // delimiter
    Serial.print(acc.z(), DEC); // data
    Serial.print (",");   // delimiter
    Serial.print(system, DEC ); // data
    Serial.print (",");   // delimiter
